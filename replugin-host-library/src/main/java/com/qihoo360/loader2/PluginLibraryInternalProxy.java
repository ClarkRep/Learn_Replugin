...
public class PluginLibraryInternalProxy {
    ...
    public boolean startActivity(Context context, Intent intent, String plugin, String activity, int process, boolean download) {
        Log.d(RePlugin.MY_TAG, "PluginLibraryInternalProxy.startActivity() -> activity = " + activity);
        if (LOG) {
...
//        } else {
        ...
        Log.d(RePlugin.MY_TAG, "PluginLibraryInternalProxy.startActivity() -> 启动坑位Activity = " + cn.getClassName());
        context.startActivity(intent);
