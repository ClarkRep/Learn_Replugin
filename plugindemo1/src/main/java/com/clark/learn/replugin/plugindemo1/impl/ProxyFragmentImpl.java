...
import com.clark.learn.replugin.plugindemo1.TestPendingIntentActivity;
import com.qihoo360.replugin.RePlugin;

public class ProxyFragmentImpl implements IProxyFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View inflate = LayoutInflater.from(context).inflate(R.layout.view_proxy_fragment_impl, viewGroup, false);
        inflate.findViewById(R.id.btn_click1).setOnClickListener((v) -> {
            Intent intent = new Intent(getContext(), TestPendingIntentActivity.class);
