...
public class TestFragment extends Fragment {
    ...
    private static final String PLUGIN_FRAGMENT_VIEW_IMPL = "com.clark.learn.replugin.plugindemo1.TestFragmentViewImpl";
    ...
    public TestFragment() {
        ...
        try {
            Class<?> fragmentClass = d1ClassLoader.loadClass(PLUGIN_FRAGMENT_VIEW_IMPL);
            mIFragmentView = fragmentClass.asSubclass(IFragmentView.class).newInstance();//使用插件的Classloader获取指定Fragment实例
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
