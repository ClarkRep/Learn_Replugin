...
public class TestAddPluginViewActivity extends FragmentActivity {
    ...
    private void addPluginView(ViewGroup container) {
        ...
        try {
            ...
            Class<?> fragmentClass = d1ClassLoader.loadClass("com.clark.learn.replugin.plugindemo1.TestAddPluginView");
